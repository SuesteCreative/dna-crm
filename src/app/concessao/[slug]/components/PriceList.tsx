...
const LABELS: Record<Lang, {
  ...
  pt: {
    ...
    extraBedDesc: "3 espreguiçadeiras + chapéu", oneBedDesc: "Apenas 1 espreguiçadeira",
  ...
  en: {
    ...
    extraBedDesc: "3 loungers + umbrella", oneBedDesc: "1 lounger only",
  ...
  es: {
    ...
    extraBedDesc: "3 tumbonas + sombrilla", oneBedDesc: "Solo 1 tumbona",
  ...
  fr: {
    ...
    extraBedDesc: "3 transats + parasol", oneBedDesc: "1 transat seulement",
  ...
  de: {
    ...
    extraBedDesc: "3 Liegestühle + Sonnenschirm", oneBedDesc: "Nur 1 Liegestuhl",
  ...
  zh: {
    ...
    extraBedDesc: "3 张躺椅 + 遮阳伞", oneBedDesc: "仅 1 张躺椅",
  ...
  ru: {
    ...
    extraBedDesc: "3 шезлонга + зонт", oneBedDesc: "Только 1 шезлонг",
...
export default function PriceList({ concession }: { concession: Concession }) {
  ...
  const items = [
    ...
    { label: L.extraBed, desc: L.extraBedDesc, price: concession.priceFull + concession.priceExtraBed, highlight: false },
    { label: L.oneBed, desc: L.oneBedDesc, price: concession.priceOneBed, highlight: false },
  ];
